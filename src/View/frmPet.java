...
public class frmPet extends javax.swing.JFrame {
   ...
   private void RefreshCatReport() {        
        ...
        JFreeChart chart = ChartFactory.createPieChart("Cats Classification By health status", dataset, true, true, true);
    ...
    private void btnExportarPetListActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportarPetListActionPerformed
        ...
        try {
            FileOutputStream file = new FileOutputStream("pet_list_resport.xls");
            //FileOutputStream file = new FileOutputStream("dog_list_resport.xls");
            //FileOutputStream file = new FileOutputStream("cat_list_resport.xls");
            book.write(file);
            file.close();
    ...
    private void btnRestartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRestartActionPerformed
        // TODO add your handling code here:
        frmPet frmPet = new frmPet();//para volver a llamar al mismo formulario en lugar de estar cerréndolo y volviéndolo a abrir! (se podría apuntar a otro formulario también)
